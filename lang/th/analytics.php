...
return [
  ...
  'description' => 'หน้านี้ประกอบด้วยข้อมูลการวิเคราะห์พื้นฐาน (ทั้งที่เก็บไว้และแสดงโดยไม่มีการระบุข้อมูลส่วนบุคคล) สำหรับจำนวนการเข้าชมหน้าทั้งหมดในแอปในช่วง :days วันที่ผ่านมา',
