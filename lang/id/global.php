...
return [
  ...
  "notFound" => [
    ...
    "suggestions" => [
      "heading" => "Mencari sesuatu?",
      "description" => "Berikut adalah beberapa halaman yang mungkin dapat membantu.",
      "picker" => "Pemilih Stempel Waktu",
      "botInfoDescription" => "Informasi tentang aplikasi Discord dan perintah yang tersedia.",
      "discordCta" => "Merasa ada yang kurang? Bergabunglah dengan server Discord dan beri tahu kami.",
      "discordButton" => "Gabung ke Server Discord",
    ],
  ],
  "maintenanceMode" => [
    ...
    'autoReload' => 'Halaman akan dimuat ulang secara otomatis <1/>',
    'reloadButton' => 'Muat ulang secara manual',
    "supportServerButton" => "Server Dukungan",
  ],
  'incompleteTranslations' => 'Terjemahannya belum lengkap',
  'contributeTranslations' => 'Kontribusi',
  'timezoneBadge' => [
    'currently' => 'Diamati saat ini',
    'atPickedDate' => 'Diamati pada waktu yang dipilih',
    'currentlyAndAtPickedDate' => 'Diamati saat ini & pada waktu yang dipilih',
  ],
  ...
  'sidebar' => [
    'inputSettings' => [
      ...
      'timezoneStickyHeaders' => [
        'label' => 'Header grup zona waktu',
        'description' => 'Tampilkan header grup yang tetap (misalnya Amerika, Eropa) di menu tarik-turun pemilih zona waktu.',
      ],
      'hourCycle' => [
        'label' => 'Format waktu',
        'description' => 'Ubah cara waktu ditampilkan di seluruh aplikasi, termasuk input waktu kustom dan pratinjau.',
        'options' => [
