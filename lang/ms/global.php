...
return [
  ...
  "notFound" => [
    ...
    "suggestions" => [
      ...
      "description" => "Di sini ada beberapa halaman yang mungkin membantu:",
      "picker" => "Pemungut Cap Masa",
      "botInfoDescription" => "Maklumat mengenai apl Discord dan perintah yang tersedia",
      "discordCta" => "Rasa ada sesuatu yang hilang? Sertai pelayan Discord dan beritahu kami.",
      "discordButton" => "Sertai Pelayan Discord",
    ],
  ],
  "maintenanceMode" => [
  ...
  'timezoneBadge' => [
    'currently' => 'Dicerap ketika ini',
    'atPickedDate' => 'Dicerap pada masa yang dipungut',
    'currentlyAndAtPickedDate' => 'Dicerap ketika ini & pada masa yang dipungut',
  ],
  ...
  'sidebar' => [
    'inputSettings' => [
      ...
      'timezoneStickyHeaders' => [
        'label' => 'Pengepala kumpulan zon waktu',
        'description' => 'Tunjukkan pengepala kumpulan (cth. America, Europe) yang terlekit pada menu ke bawah pilihan zon waktu.',
      ],
      'hourCycle' => [
        'label' => 'Format masa',
        'description' => 'Ubah cara masa dipaparkan di seluruh aplikasi, termasuk input masa tersuai dan pratonton.',
        'options' => [
