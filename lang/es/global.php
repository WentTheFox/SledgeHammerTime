...
return [
  ...
  "maintenanceMode" => [
    ...
    'autoReload' => 'La página se recargará automáticamente <1/>',
    'reloadButton' => 'Recargar manualmente',
    "supportServerButton" => "Servidor de soporte",
    "contactDeveloperButton" => "Contactar al desarrollador",
  ],
  'incompleteTranslations' => 'Las traducciones están incompletas',
  'contributeTranslations' => 'Contribuye',
  'timezoneBadge' => [
    'currently' => 'Observado actualmente',
    'atPickedDate' => 'Observado en el momento elegido',
    'currentlyAndAtPickedDate' => 'Observado actualmente y en el momento elegido',
  ],
  ...
  'sidebar' => [
    'inputSettings' => [
      ...
      'timezoneStickyHeaders' => [
        'label' => 'Cabeceras de grupos de zonas horarias',
      ...
      'firstDayOfWeek' => [
        ...
        'description' => 'Cambie qué día debe considerarse el primer día de la semana en el calendario de la entrada de fecha personalizada.',
        'options' => [
          'default' => 'Lenguaje por defecto',
        ],
      ],
