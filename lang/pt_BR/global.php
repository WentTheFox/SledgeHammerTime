...
return [
  ...
  "notFound" => [
    ...
    "suggestions" => [
      ...
      "discordCta" => "Acredita que falta algo? Entre no servidor do Discord e nos avise.",
      "discordButton" => "Entre no servidor do Discord",
    ],
  ],
  "maintenanceMode" => [
  ...
  'timezoneBadge' => [
    ...
    'atPickedDate' => 'Observado no momento selecionado',
    'currentlyAndAtPickedDate' => 'Observado atualmente e no momento selecionado',
  ],
  ...
  'sidebar' => [
    'inputSettings' => [
      ...
      'timezoneStickyHeaders' => [
        'label' => 'Cabeçalhos do grupo de Fuso Horário',
        'description' => 'Mostrar cabeçalhos de grupo fixo (ex.: América, Europa) no menu de seleção de fuso horário.',
      ],
      'hourCycle' => [
        'label' => 'Formato de hora',
        'description' => 'Altere como a hora é exibida em todo o aplicativo, incluindo a entrada personalizada de hora e as pré-visualizações.',
        'options' => [
