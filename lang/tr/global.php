...
return [
  ...
  'timezoneBadge' => [
    'currently' => 'Şu anda geçerli',
    'atPickedDate' => 'Seçilen zamanda geçerli',
    'currentlyAndAtPickedDate' => 'Şu anda ve seçilen zamanda geçerli',
  ],
  ...
  'sidebar' => [
    'inputSettings' => [
      ...
      'timezoneStickyHeaders' => [
        'label' => 'Zaman dilimi grup başlıkları',
