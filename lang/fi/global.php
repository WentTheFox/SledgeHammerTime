...
return [
  ...
  "notFound" => [
    ...
    "suggestions" => [
      "heading" => "Etsitkö jotakin?",
      "description" => "Nämä sivut saattavat auttaa:",
      "picker" => "Aikaleiman valitsin",
      "botInfoDescription" => "Tietoa Discord apista ja saatavilla olevia komentoja",
      "discordCta" => "Luuletko että jotakin puuttuu? Liity Discord-palvelimellemme ja kerro meille.",
      "discordButton" => "Liity Discord-palvelimelle",
    ],
  ],
  "maintenanceMode" => [
    "heading" => "Huoltotila",
    ...
    "contactDeveloperButton" => "Ota yhteyttä kehittäjään",
  ],
  ...
  'sidebar' => [
    ...
    'timeSync' => [
      ...
      'status' => [
        ...
        'value' => 'Ero paikallis- ja palvelinajan kanssa on :offset.',
      ],
      'details' => 'Lisätiedot',
