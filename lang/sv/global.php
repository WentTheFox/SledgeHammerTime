...
return [
  'seoDescription' => 'Generera tidsstämpelindikatorer för Discord-meddelanden',
  'changeLanguage' => 'Byt språk',
  "notFound" => [
    "heading" => "Sidan kunde inte hittas",
    "content" => "Inget att se här.",
    "suggestions" => [
      "heading" => "Letar du efter något?",
      "description" => "Här är några sidor som kan vara till hjälp:",
      "picker" => "Tidsstämpel-väljaren",
      "botInfoDescription" => "Information om Discord-appen och tillgängliga kommandon",
      "discordCta" => "Saknar du något? Gå med i vår Discord-server och låt oss veta.",
      "discordButton" => "Gå med i vår Discord-server",
    ],
  ],
  "maintenanceMode" => [
    "heading" => "Underhållsläge",
    "content" => [
      'pleaseWait' => "Applikationen uppdateras för närvarande, försök igen inom kort.",
      'joinSupportServer' => "Om problemet kvarstår i mer än ett par minuter, gå med i vår Discord-server och låt oss veta.",
  ...
  'incompleteTranslations' => 'Översättningarna är ofullständiga',
  ...
  'jsDisabled' => [
    'title' => 'JavaScript krävs',
    'body' => "Din webbläsare stödjer inte JavaScript eller så är det inaktiverat för tillfället. Vissa webbläsare inaktiverar JavaScript som standard för säkerhetsskäl, men det är nödvändigt för den här applikationen. Aktivera det och uppdatera sidan, eller använd en annan webbläsare.",
  ],
  'nav' => [
  ...
  'sidebar' => [
    ...
    'credits' => [
      ...
      'vueTippy' => 'VueTippy',
      'chrono' => 'chrono',
      'translatedBy' => 'Översättningar av <1></1>',
      'openSourceSoftware' => 'Öppen källkod',
      'viewSourceCode' => 'Se källkoden',
      'notAffiliated' => 'Detta projekt är inte kopplat till Discord.',
    ],
    'themeButton' => [
      'dark' => 'Dark Theme',
      'light' => 'Light Theme',
