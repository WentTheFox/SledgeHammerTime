...
return [
  ...
  "notFound" => [
    ...
    "suggestions" => [
      "heading" => "Търсите ли нещо?",
      "description" => "Ето някои страници, които биха помогнали:",
      "picker" => "Timestamp Picker",
      "botInfoDescription" => "Информация за Discord и наличните команди",
      "discordCta" => "Смятате, че нещо липсва? Присъединете се към Discord сървъра и споделете.",
      "discordButton" => "Присъедини се към Discord сървъра",
    ],
  ],
  "maintenanceMode" => [
    "heading" => "Режим на профилактика",
    "content" => [
      'pleaseWait' => "Приложението се актуализира, моля опитайте отново след няколко секунди.",
      'joinSupportServer' => "Ако проблемът продължава повече от няколко минути, моля, присъединете се към Discord сървъра и ни уведомете.",
      'contactDeveloper' => "Ако проблемът продължава повече от няколко минути, моля, свържете се с разработчика и го уведомете.",
    ],
