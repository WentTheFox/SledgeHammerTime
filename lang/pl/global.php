...
return [
  ...
  "maintenanceMode" => [
    ...
    'autoReload' => 'Strona automatycznie się odświeży <1/>',
    'reloadButton' => 'Odśwież ręcznie',
  ...
  'timezoneBadge' => [
    'currently' => 'Obecnie obserwowane',
    'atPickedDate' => 'Obserwowane w wybranym czasie',
    'currentlyAndAtPickedDate' => 'Obserwowane obecnie i w wybranym czasie',
  ],
  ...
  'sidebar' => [
    'inputSettings' => [
      ...
      'naturalLanguageInput' => [
        'label' => 'Pole wprowadzania @time',
        'description' => 'Umożliwienie manipulowania wybranym znacznikiem czasu za pomocą języka naturalnego (np. "za 5 godzin") za pomocą dodatkowego pola tekstowego. Podobnie jak w przypadku nowego tagu Discord @time. Obsługiwana jest tylko ograniczona liczba języków.',
      ],
      'customDateInput' => [
