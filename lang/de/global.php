...
return [
  ...
  "maintenanceMode" => [
    ...
    'autoReload' => 'Die Seite wird automatisch neu geladen <1/>',
    'reloadButton' => 'Manuell neu laden',
  ...
  'sidebar' => [
    'inputSettings' => [
      ...
      'firstDayOfWeek' => [
        ...
        'description' => 'Ändere, welcher Tag als erster Tag der Woche im Kalender der benutzerdefinierte Eingabe, gelten soll.',
        'options' => [
          'default' => 'Betriebssystem Standard',
        ],
      ],
