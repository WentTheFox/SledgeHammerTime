...
return [
  ...
  'creditOverrides' => [
    ...
    'gravatarEmail' => 'Indirizzo e-mail',
    'gravatarDescription' => '<1>Gravatar</1> consente di utilizzare un singolo avatar su più siti web che lo supportano. Il tuo indirizzo e-mail verrà salvato come hash MD5.',
    ...
    'currentlyApproved' => 'Valori attualmente approvati',
    'reApprovalWarning' => 'La modifica di qualsiasi cosa oltre alla visibilità richiederà una revisione manuale. È possibile annullare la richiesta di revisione in qualsiasi momento da questa pagina.',
    'deleteOverride' => 'Ripristina valori predefiniti',
    'deleteOverrideConfirm' => 'Sei sicuro di voler rimuovere l\'override del credito di traduzione? La tua voce tornerà alle informazioni predefinite da Crowdin.',
    'approvedValues' => [
      'displayName' => 'Nome',
      'avatarProvider' => 'Fornitore avatar',
      'avatarId' => 'ID Avatar',
      'url' => 'URL del profilo',
      'visible' => 'Visibile',
      'hidden' => 'Nascosto',
